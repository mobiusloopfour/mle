...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    CMD = 4,                       // CMD
    TEXT = 5,                      // TEXT
    RANGE_WILDCARD = 6,            // RANGE_WILDCARD
    COMMA = 7,                     // COMMA
    WRITE = 8,                     // WRITE
    NEWLINE = 9,                   // NEWLINE
    QUIT = 10,                     // QUIT
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_CMD = 4,                               // CMD
        S_TEXT = 5,                              // TEXT
        S_RANGE_WILDCARD = 6,                    // RANGE_WILDCARD
        S_COMMA = 7,                             // COMMA
        S_WRITE = 8,                             // WRITE
        S_NEWLINE = 9,                           // NEWLINE
        S_QUIT = 10,                             // QUIT
        ...
        S_entries = 15,                          // entries
        S_entry = 16,                            // entry
        S_comms = 17,                            // comms
        S_comm = 18,                             // comm
        S_range = 19,                            // range
        S_range_literal = 20                     // range_literal
      };
    };
...
switch (yykind)
    ...
    parser (MLE::Driver& ProgramDriver_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_RANGE_WILDCARD ()
      {
        return symbol_type (token::RANGE_WILDCARD);
      }
#else
      static
      symbol_type
      ...
      make_APPEND ()
      {
        return symbol_type (token::APPEND);
      }
#else
      static
      symbol_type
